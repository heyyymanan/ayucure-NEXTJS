...
const PrivacyPolicy = () => {
    return (
        <div className="max-w-5xl mx-auto px-4 py-10 text-gray-800 space-y-6">
            ...
            <p>
                Shreeji Remedies recognises the importance of maintaining your privacy.
                We value your privacy and appreciate your trust in us. This Privacy Policy sets
                out how Shreeji Remedies uses and protects any information that you give Shreeji
                Remedies when you use this https://bynatablet.in or the Shreeji Remedies mobile
                application or any other digital medium and other offline sources of our Company.
                Shreeji Remedies is committed to ensure that your privacy is protected. Should
                we ask you to provide certain information by which you can be identified when
                using this website, then you can be assured that it will only be used in accordance
                with this Privacy Policy as it describes how we treat user information we collect
                from you, the policies and procedures on the collection, use, disclosure and
                protection of your information when you use our Shreeji Remedies Platform.
            </p>
            <p>
                This Privacy Policy applies to current and former visitors to our Shreeji Remedies
                Platform and to our online customers. By visiting and/or using our website, you agree
                to this Privacy Policy. Shreeji Remedies may change this policy from time to time by
                updating this page. You should check this page from time to time to ensure that you
                are happy with any changes.
            </p>
            <p>
                https://bynatablet.in is a property of Shreeji Remedies, Proprietor, established under
                laws of India, having its registered office at Proprietor, Rajasthan - 313001.
            </p>

            <h2 className="text-2xl font-semibold">DEFINITIONS:</h2>
            <p>
                The terms "Shreeji Remedies", "Company", "we", "us" and "our" refer to the Shreeji Remedies.
                The term "Shreeji Remedies Platform" refers to https://bynatablet.in or the Shreeji Remedies
                mobile application or any other digital medium and other offline sources.
                The terms "you" and "your" refer to the user of the https://bynatablet.in.
                ...
                Relative (as such term is defined in the Companies Act, 1956 and Companies Act, 2013 to
                the extent applicable) of such person.
                The term "Services" refers to any services offered by Shreeji Remedies whether on the
                Swiggy Platform or otherwise.
                The term "Policy" refers to this Privacy Policy.
            </p>

            <h2 className="text-2xl font-semibold">INFORMATION WE COLLECT FROM YOU:</h2>
            <p>Contact information:
                We might collect your Name, Email, Phone, Address.
                ...
                payment partner phonepay. <br /><br />
                Information you post:
                We collect information you post in a public space on our Shreeji
                Remedies Platform or on a third-party social media site
                belonging to Shreeji Remedies.<br /><br /><br />
                Usage and Preference Information:
                We collect information as to how you interact with our Services,
                preferences expressed and settings chosen. Shreeji Remedies
                Platform includes the Shreeji Remedies advertising services
                ("Ad Services"), which may collect user activity and browsing
                history within the Shreeji Remedies Platform and across third party sites and online services, including those sites and services
                that include our ad pixels ("Pixels"), widgets, plug-ins, buttons, or
                ...
                agent, Shreeji Remedies cookie ID (if applicable), time zone
                setting, browser plug-in types and versions, operating system
                and platform, and other information about user activities on the
                Shreeji Remedies Platform, as well as on third party sites and
                services that have embedded our Pixels, widgets, plug-ins,
                buttons, or related services.<br /><br />
                ...
                related transaction details.<br /><br />
                tored information and files:
                Shreeji Remedies mobile application (Shreeji Remedies app)
                may also access metadata and other information associated with
                other files stored on your mobile device. This may include, for
                example, photographs, audio and video clips, personal contacts
                and address book information. If you permit the Shreeji
                Remedies app to access the address book on your device, we
                may collect names and contact information from your address
                book to facilitate social interactions through our services and for
                other purposes described in this Policy or at the time of consent
                or collection. If you permit the Shreeji Remedies app to access
                the calendar on your device, we collect calendar information
                such as event title and description, your response (Yes, No,
                Maybe), date and time, location and number of attendees. If you
                are a partner company, we will, additionally, record your calls
                with us made from the device used to provide Services, related
                call details, SMS details location and address details.<br /><br />
                ...
                other information provided by you during the use of Shreeji
                Remedies Platform. We might collect this as a part of a survey
                also.<br /><br />
                Other information:
                If you use Shreeji Remedies Platform, we may collect
            ...
            <h2 className="text-2xl font-semibold">WAYS OF COLLECTING INFORMATION:</h2>
            <p>
                We collect information directly from you: <br /><br />
                We collect information directly from you when you register on
                Shreeji Remedies Platform. We also collect information if you
                post a comment on Shreeji Remedies Platform or ask us a
                question through phone or email or any other source of
                communication. <br /><br />
                We collect information from you passively:
                We use tracking tools like Google Analytics, Google
                Webmaster, Google Cookies for collecting information about
                your usage of our website. <br /><br />
                ...
                Services we provide. Users of our Ad Services and other third parties may share information with us such as the cookie ID,
                ...
                When you sign in to Shreeji Remedies Platform with your SNS
                account, or otherwise connect to your SNS account with the
                ...
                to connect your account.If you are partner company, we may, additionally, receive
                feedback and rating from other users
            </p>
            <h2 className="text-2xl font-semibold">USE OF YOUR PERSONAL INFORMATION:</h2>
            <p>
                We use information to contact you:
                We might use the information you provide to contact you for
                confirmation of a purchase on Shreeji Remedies Platform or for
                other promotional purposes.<br /><br />
                ...
                rendering services we offer.<br /><br />
                ...
                how they use them, etc.), improve the content and features of
                ...
                track the progress of your service to our customers.<br /><br />
                ...
                information about you we get from third parties. We may use your information to provide you with information about services
                ...
                limitation.<br /><br />
                We analyse the log files of our Shreeji Remedies Platform that
                may contain Internet Protocol (IP) addresses, browser type and
                language, Internet service provider (ISP), referring, app crashes,
                page viewed and exit websites and applications, operating
                system, date/time stamp, and clickstream data. This helps us to administer the website, to learn about user behavior on the site,
                to improve our product and services, and to gather demographic
                information about our user base as a whole.
            </p>
            <h2 className="text-2xl font-semibold">SHARING/DISCLOSURE/DISTRIBUTION OF YOUR INFORMATION WITH THIRD-PARTIES:</h2>
            <p>
                ...
                While you cannot opt out of advertising on the Shreeji
                Remedies Platform, you may opt out of much interest-based
                ...
                networks from which you have opted out, which is based on your rowsing information across multiple sites and online services. If
                you delete cookies or change devices, your ‘opt out’ may no
                longer be effective to fulfill the purpose for which you provide it.<br /><br />
                We will share information with our business partners:<br /><br />
                ...
                privacy policies.
                While you place a request to order through the Shreeji
                Remedies Platform, your information is provided to us and to the
                ...
                provide a mobile phone number, Shreeji Remedies may send
                you text messages regarding the orders delivery status.<br /><br />
                We will share information with Other Users:<br /><br />
                ...
                other users to provide them the Services.<br /><br />
                We may share information if we think we have to in order to
                comply with the law or to protect ourselves:<br /><br />
                ...
                to your use of our Services. This includes exchanging information ith other companies and organisations for the purposes of fraud
                detection and credit risk reduction.<br /><br />
                We may share information for Internal Use or may share it
                with any successor to all or part of our business:<br /><br />
                ...
                defined above) or affiliates for our internal business purposes.<br /><br />
                ...
                you before we do this.<br /><br /><br /><br />
            </p>
            <h2 className="text-2xl font-semibold">YOUR CONSENT:</h2>
            <p>
                By using the Shreeji Remedies Platform and the Services
                provided therein, you agree and consent to the collection,
                transfer, use, storage, disclosure and sharing of your information
                as described and collected by us in accordance with this Policy. If
                you do not agree with the Policy, please do not use or access the
                Shreeji Remedies Platform.
            </p>
            <h2 className="text-2xl font-semibold">COOKIES:</h2>
            <p>
                Our Shreeji Remedies Platform and third parties with whom
                we partner, may use cookies, pixel tags, web beacons, mobile
                device IDs, "flash cookies" and similar files or technologies to
                collect and store information with respect to your use of the
                ...
                technologies to identify your device when you visit the Shreeji
                Remedies Platform and use our Services, as well as when you
                visit other online sites and services.
            ...
            <h2 className="text-2xl font-semibold">DATA SECURITY PRECAUTIONS:</h2>
            <p>
                ...
                Shreeji Remedies Platform, you are responsible for keeping
                these details confidential. We ask you not to share your
                ...
                your data transmitted through the Shreeji Remedies Platform.
                Once we have received your information, we will use strict
                physical, electronic, and procedural safeguards to try to prevent
                unauthorised access.
            </p>
            <h2 className="text-2xl font-semibold">Email OPT-OUT:</h2>
            <p>
                You can opt out of receiving our marketing emails. To stop
                receiving our promotional emails, please email (no-reply@bynatablet.in). It may take about 7 days to process
                your request. Even if you opt out of getting marketing messages,
                we will still be sending you transactional messages through email
                and SMS about your purchases.
            </p>
            <h2 className="text-2xl font-semibold">THIRD PARTY SITES:</h2>
            <p>
                The Shreeji Remedies Platform may contain links to other
                websites. If you click on one of the links to third party websites,
                you may be taken to websites we do not control. Any personal
                information about you collected whilst visiting such websites is
                not governed by this Policy. Shreeji Remedies shall not be
                responsible for and has no control over the practices and content
                of any website accessed using the links contained on the Shreeji
                Remedies Platform. Read the privacy policy of other websites
                carefully as this policy does not apply to the privacy practices of
                those websites. We are not responsible for these third party
                sites.
            ...
            <p>
                ...
                Name: Jyoti Mitra Vyas <br />
                Address: 37, Gyan Marg, near R.M.V. School, Old City, Surajpole, Brahmpuri, Udaipur, Rajasthan 313001 <br />
                Phone Number: +91-9928077671 <br />
                Email Address: shreejiremedies25@gmail.com
            </p>
            ...
            <p>
                ...
                Policy shall be governed by the laws of India. urther, please note that the Shreeji Remedies Platform
                stores your data with the cloud platform of hostinger provided by
                Hostinger, which may store this data on
                their servers located India. hostinger has security measures in
                place to protect the loss, misuse and alteration of the
                information, details of which are available at
                https://www.hostinger.com/in. The privacy policy adopted by
                hostinger are detailed in
                https://www.hostinger.com/in/legal/privacy-policy.
                In the event you have questions or concerns about the
                security measures adopted by hostinger, you can contact their
                data protection/ privacy team/ legal team or designated
                grievance officer at these organisations, whose contact details
                are available in its privacy policy, or can also write to our
                Grievance Officer at the address provided above.
